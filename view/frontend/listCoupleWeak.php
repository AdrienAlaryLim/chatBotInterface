...
<section class="main style3">
	...
	<table class="tabLicence">
			<tr>
				...
				<th class="tabLicence">Id Réponse</th>
				<th class="tabLicence">Réponse</th>
			...
			?>
				<tr>
					<td class="tabLicence"> <?php echo $data['id_question']; ?></td>
					<td class="tabLicence" style="width: 40%;"> <?php echo $data['question']; ?></td>
					<td class="tabLicence"> <?php echo $data['id_reponse']; ?></td>
