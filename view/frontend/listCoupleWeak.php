	...
	<table class="tabLicence">
			...
			?>
				<tr>
					...
					<td class="tabLicence" style="width: 110px;"> <a href=<?php echo '"index.php?action=modifierCouple&idReponse='.$data['id_reponse'].'&idQuestion='.$data['id_question'].'"';?>> <img src="public/images/plus_36px.png" alt="Add_Response"> </a> </td>
				</tr>
			<?php
			}				
			$list->closeCursor();
