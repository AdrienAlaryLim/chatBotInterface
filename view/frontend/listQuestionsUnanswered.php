...
<section class="main style3">
    ...
    <!--<div class="row gtr-150"> !-->
        <div class="col-6 col-12-medium"> 
        	<?php 
        		...
        		<br> <br>
                	Voici la liste des questions dont la réponse est inexistante
            	</p>';
	...
	<table class="tabLicence">
			<tr>
				...
				<th class="tabLicence">Ajouter réponse</th>
			</tr>
			...
			?>
				<tr>
					...
					<td class="tabLicence" style="width: 150px; padding:5px;"> 
						<a href=<?php echo '"index.php?action=creerReponse&idQuestion='.$data['id_question'].'"';?>> <img src="public/images/plus_36px.png" alt="Add_Response"> </a> </td>
				</tr>
			<?php
			}				
			$list->closeCursor();
